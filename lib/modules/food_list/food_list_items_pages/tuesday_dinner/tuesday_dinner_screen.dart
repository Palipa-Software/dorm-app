...
import 'package:dorm_app/modules/food_list/food_list_items_pages/tuesday_dinner/tuesday_dinner_controller.dart';
...
class TuesdayDinnerScreen extends GetView<TuesdayDinnerController> {
  TuesdayDinnerScreen({super.key});
                                    ...
                                    return Switch(
                                        ...
                                        onChanged: (Value) {
                                          if (controller.isNotCome.value ==
                                            ...
                                            SharedPrefs.setBool(
                                                "${FirebaseAuth.instance.currentUser!.email.toString()}tuesday",
                                                controller.isNotCome.value);
                                            _controller.isNotComePersonCreate(
                                                "tuesdayDinnerIsNotCome");
