...
class MondayDinnerScreen extends GetView<MondayDinnerController> {
  const MondayDinnerScreen({super.key});
                                    ...
                                    return Switch(
                                        ...
                                        onChanged: (Value) {
                                          if (controller.isNotCome.value ==
                                            ...
                                            controller.isNotComePersonCreate(
                                                "mondayDinnerIsNotCome");
                                            controller.updateDocumentCount(
                                                "mondayDinnerIsNotCome");
                                          } else {
                                            ...
                                            controller.isNotComePersonDelete(
                                                "mondayDinnerIsNotCome");
                                            controller.updateDocumentCount(
                                                "mondayDinnerIsNotCome");
                                          }
