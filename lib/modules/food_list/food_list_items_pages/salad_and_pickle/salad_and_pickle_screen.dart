...
class SaladAndPickleScreen extends GetView<BreakfastController> {
  const SaladAndPickleScreen({super.key});
            ...
            Container(
              ...
              child: ListView.separated(
                  itemBuilder: (context, index) {
                    return FoodListItems.saladAndPickle[index];
                  },
                  separatorBuilder: (context, index) => SizedBox(
                        height: 2.h,
                      ),
                  itemCount: FoodListItems.saladAndPickle.length),
            )
          ],
        ),
      ),
